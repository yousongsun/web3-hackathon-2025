...
/**
 * Deploys a contract named "SimpleDao" using the deployer account and
...
const deploySimpleDao: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  */
  ...
  const initialMembers = ["0x90A28F6f9f25CBF2aff22370C3509f4C93516CBe"];

  const initialBalances = [
    ethers.parseEther("300"), // 300 tokens for the third member
  ];
  ...
  // // console.log("👋 Initial greeting:", await SimpleDao.greeting());
};
